...
FFXIV SimHelper(이하 Simhelper)는 One & Done 공대 내에서 직업 분석을 위해 만든 시뮬레이션 프로그램입니다.
...
SimHelper는 수 많은 장비 조합 중 어떤 것이 더 좋은지 알려줍니다.

![gearcompare](../../images/ffxivsimhelperguide3.png)

## 주의점:

Simhelper는 **초급/중급 유저**의 직업 숙련도를 빠르게 개선시키는 것에도 집중합니다.
